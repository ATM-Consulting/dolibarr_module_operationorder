...
/**
 *	Class to generate PDF orders with template olaf
 */
class pdf_olaf extends ModelePDFOperationOrder
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		{
			$this->error=$langs->transnoentities("ErrorConstantNotDefined", "OPERATIONORDER_OUTPUTDIR");
			return 0;
		}
	}
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey = "PdfOrderTitle")
	{
		...
		if($object->statut==0 && (! empty($conf->global->OPERATIONORDER_DRAFT_WATERMARK)) )
		{
            pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', $conf->global->OPERATIONORDER_DRAFT_WATERMARK);
		}
