...
setup_print_input_form_part($confKey, $langs->trans('OPERATION_ORDER_GROUPUSER_DEFAULTPLANNING'), '', array(), $form->select_dolgroups('', 'OPERATION_ORDER_GROUPUSER_DEFAULTPLANNING'));
